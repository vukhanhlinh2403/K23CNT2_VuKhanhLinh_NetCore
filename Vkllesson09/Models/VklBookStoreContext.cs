...
public partial class VklBookStoreContext : DbContext
{
    public VklBookStoreContext()
    {
    }

    public VklBookStoreContext(DbContextOptions<VklBookStoreContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=LAPTOP-C30ND4U3\\MAY1;Database=VklBookStore;Trusted_Connection=True;MultipleActiveResultSets=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            entity.HasKey(e => e.AccountId).HasName("PK__Account__349DA5A6F37DD777");
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Book__3DE0C207628F7EAF");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__19093A0BD6DCA8F6");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__OrderBoo__C3905BCF32015C80");
        ...
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__D3B9D36CDC8C4C86");
        ...
        {
            entity.HasKey(e => e.PublisherId).HasName("PK__Publishe__4C657FABB4AE4FBC");
